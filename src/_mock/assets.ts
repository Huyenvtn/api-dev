...
export const _eventNames = [
  `hAnnual General Meeting`,
  `hSummer Music Festival`,
  `hTech Innovators Conference`,
  `hCharity Gala Dinner`,
  `hSpring Art Exhibition`,
  `hCorporate Training Workshop`,
  `hCommunity Health Fair`,
  `hStartup Pitch Night`,
  `hRegional Sports Tournament`,
  `hBook Launch Event`,
  `hFilm Premiere Screening`,
  `hIndustry Networking Mixer`,
  `hHoliday Craft Fair`,
  `hEnvironmental Awareness Week`,
  `hNew Year's Eve Party`,
  `hProduct Release Showcase`,
  `hCultural Heritage Festival`,
  `hScience and Technology Expo`,
  `hAnnual Awards Ceremony`,
  `hFashion Week Runway Show`,
  `hFood and Wine Tasting`,
  `hOutdoor Adventure Camp`,
  `hLeadership Summit`,
  `hWedding Expo`,
];
